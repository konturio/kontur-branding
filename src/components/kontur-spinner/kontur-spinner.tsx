...
export class Spinner {
  ...
  nextFrame() {
    this.timeout = requestAnimationFrame(() => {
      const newOffset = this.dashOffset + this.speed;
      this.dashOffset = newOffset > this.maxOffset ? 0 : newOffset;
      this.nextFrame();
    });
  }

  connectedCallback() {
    this.dashOffset = Number(this.frame);
    this.nextFrame();
  }
  ...
  render() {
    ...
    >
      ...
      <rect
        ...
        stroke-dashoffset={68 + this.dashOffset}
      />
    </svg>
  }
}
